...
const system = (text: string, count: number): string => {
  ...
  if (rate < -20) {
    return `日本語の文章を入力に基づき、文章の長さを${dispRate}%短縮してください。重要度が低い部分から順に削除または短縮することでこれを実現してください。 #Steps 1.理解:入力された文章をよく読み、その主題や重要なポイント、全体の流れ、および文体や表現の癖を把握します。2.評価:各部分の重要度を評価し、優先順位をつけます。3.削除・短縮:重要度が低い部分から順に${dispRate}%を削除または短縮し、全体の長さを${dispRate}%短縮します。文体や表現の癖を可能な限り保ちます。4.再構築:元の文体を保ちつつ、全体として意味が通るように流れを整え文章を再構成します。 #OutputFormat 文章の流れや意味が損なわれないように、短縮された文章を適切に整えて提供してください。また元の文体や表現の癖が維持されていることを確認してください。 #Notes -元の文章の意味や流れを変えずに全体として意味が通るよう短縮してください。-文体や表現の癖として文末の表現や繰り返し使用される表現を維持してください。`;
  } else if (rate < 0) {
    return `日本語の文章を入力に基づき、文章の長さを${dispRate}%短縮してください。重要度が低い部分から順に一部の単語を削除することでこれを実現してください。 #Steps 1.理解:入力された文章をよく読み、その主題や重要なポイント、全体の流れ、および文体や表現の癖を把握します。2.評価:各部分の重要度を評価し、優先順位をつけます。3.削除:重要度が低い部分から順に${dispRate}%だけ不要な一部の単語を削除し、全体の長さを${dispRate}%短縮します。文体や表現の癖を可能な限り保ちます。4.再構築:元の文体を保ちつつ、全体として意味が通るように流れを整え文章を再構成します。 #OutputFormat 文章の流れや意味が損なわれないように、短縮された文章を適切に整えて提供してください。また元の文体や表現の癖が維持されていることを確認してください。 #Notes -${dispRate}%の軽微な短縮であることに注意してください。-元の文章の意味や流れを変えずに全体として意味が通るよう短縮してください。-文体や表現の癖として文末の表現や繰り返し使用される表現を維持してください。`;
  } else if (rate < 40) {
    return `日本語の文章を入力に基づき、文章の長さを${dispRate}%拡張してください。重要度が高い部分から順に短い単語を付加することでこれを実現してください。 #Steps 1.理解:入力された文章をよく読み、その主題や重要なポイント、全体の流れ、および文体や表現の癖を把握します。2.評価:各部分の重要度を評価し、優先順位をつけます。3.拡張:重要度が高い部分から順に${dispRate}%だけ短い単語を付加し、全体の長さを${dispRate}%拡張します。文体や表現の癖を可能な限り保ちます。4.再構築:元の文体を保ちつつ、全体として意味が通るように流れを整え文章を再構成します。 #OutputFormat 文章の流れや意味が損なわれないように、拡張された文章を適切に整えて提供してください。また元の文体や表現の癖が維持されていることを確認してください。 #Notes -${dispRate}%の軽微な拡張であることに注意してください。-元の文章の意味や流れを変えずに全体として意味が通るよう拡張してください。-文体や表現の癖として文末の表現や繰り返し使用される表現を維持してください。`;
  } else {
    return `日本語の文章を入力に基づき、文章の長さを${dispRate}%拡張してください。重要度が高い部分から順に新たな内容を追加することでこれを実現してください。 #Steps 1.理解:入力された文章をよく読み、その主題や重要なポイント、全体の流れ、および文体や表現の癖を把握します。2.評価:各部分の重要度を評価し、優先順位をつけます。3.拡張:重要度が高い部分から順に${dispRate}%へ新たな内容を追加し、全体の長さを${dispRate}%拡張します。文体や表現の癖を可能な限り保ちます。4.再構築:元の文体を保ちつつ、全体として意味が通るように流れを整え文章を再構成します。 #OutputFormat 文章の流れや意味が損なわれないように、拡張された文章を適切に整えて提供してください。また元の文体や表現の癖が維持されていることを確認してください。 #Notes -元の文章の意味や流れを変えずに全体として意味が通るよう拡張してください。-文体や表現の癖として文末の表現や繰り返し使用される表現を維持してください。`;
  }
};
